...
type AttributeDefinitionable interface {
    ...
    GetAnchor()(*bool)
    GetApiExpressions()([]SecureScoresable)
    GetCaseExact()(*bool)
    GetDefaultValue()(*string)
    GetFlowNullValues()(*bool)
    GetMetadata()([]SecureScoresable)
    GetMultivalued()(*bool)
    GetMutability()(*Mutability)
    GetName()(*string)
    GetReferencedObjects()([]SecureScoresable)
    GetRequired()(*bool)
    GetType()(*AttributeType)
    SetAnchor(value *bool)()
    SetApiExpressions(value []SecureScoresable)()
    SetCaseExact(value *bool)()
    SetDefaultValue(value *string)()
    SetFlowNullValues(value *bool)()
    SetMetadata(value []SecureScoresable)()
    SetMultivalued(value *bool)()
    SetMutability(value *Mutability)()
    SetName(value *string)()
    SetReferencedObjects(value []SecureScoresable)()
