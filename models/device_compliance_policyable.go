...
type DeviceCompliancePolicyable interface {
    ...
    GetDeviceStatusOverview()(DeviceCompliancePoliciesable)
    ...
    GetUserStatusOverview()(DeviceCompliancePoliciesable)
    GetVersion()(*int32)
    ...
    SetDeviceStatusOverview(value DeviceCompliancePoliciesable)()
    ...
    SetUserStatusOverview(value DeviceCompliancePoliciesable)()
