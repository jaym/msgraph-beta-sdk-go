...
type SecureScoreable interface {
    ...
    GetAverageComparativeScores()([]RoleDefinitionsable)
    GetAzureTenantId()(*string)
    GetControlScores()([]RoleDefinitionsable)
    GetCreatedDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetCurrentScore()(*float64)
    GetEnabledServices()([]string)
    GetLicensedUserCount()(*int32)
    GetMaxScore()(*float64)
    GetVendorInformation()(RoleDefinitionsable)
    SetActiveUserCount(value *int32)()
    SetAverageComparativeScores(value []RoleDefinitionsable)()
    SetAzureTenantId(value *string)()
    SetControlScores(value []RoleDefinitionsable)()
    ...
    SetVendorInformation(value RoleDefinitionsable)()
}
